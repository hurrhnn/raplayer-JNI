...
import xyz.hurrhnn.raplayer_jni.databinding.RoomlistBinding;
...
public class RoomListActivity extends AppCompatActivity {
    ...
    class getroomThread extends Thread{
        ...
        public void setValue(JSONArray roomlist, boolean flag, LinearLayout linearLayout){
            if(roomlist == null && linearLayout == null){
                this.flag = flag;
            } else {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RoomlistBinding binding = RoomlistBinding.inflate(getLayoutInflater());
...
//        pushprofile.start();
        ...
        try {
            ...
            getroomthread.setValue(jsonArray, true, linearLayout);
            getroomthread.start();
        } catch (JSONException e) {
            throw new RuntimeException(e);
        }
